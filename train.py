...
class Workspace:
    ...
    def train_rate(self):
        # [0.2, 0.5] -> [0, 1]
        # margin [abs, 3]
        rate = (self._global_step - self.cfg.num_train_frames * 0.2) / (self.cfg.num_train_frames * 0.3)
    ...
    def train(self, task_id=1):
        ...
        while train_until_step(self.global_step):
            ...
            self.train_env.set_training_rate(self.train_rate)
            self.eval_env.set_training_rate(self.train_rate)
            # take env step
